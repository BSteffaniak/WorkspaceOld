...
public class GLSLKeyword
{
	...
	static
	{
		...
		VEC2.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		VEC3.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		VEC4.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		MAT2.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		MAT3.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		MAT4.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		VOID.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		VERSION.setColor(new Color(ArrowIDE.display, 180, 180, 0));
		VARYING.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		UNIFORM.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		SAMPLER2D.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		GL_FRAGCOLOR.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		GL_VERTEX.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		GL_MODELVIEWMATRIX.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		GL_MODELVIEWPROJECTIONMATRIX.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		GL_POSITION.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		GL_TEXCOORD.setColor(new Color(ArrowIDE.display, 150, 0, 0));
		GL_LIGHTMODEL.setColor(new Color(ArrowIDE.display, 150, 0, 0));
	}
