...
//import net.foxycorndog.p1xelandroid.MainActivity;
...
//		
//		sunMoonVerticesBuffer.setData(0 * 4 * 2, GL.addRectVertexArrayf(0, 0, MainActivity.textureSize * 2, MainActivity.textureSize * 2, 0, null));
//		sunMoonVerticesBuffer.setData(1 * 4 * 2, GL.addRectVertexArrayf(0, 0, MainActivity.textureSize * 2, MainActivity.textureSize * 2, 0, null));
//		
...
//		for (int i = 0; i < 16; i ++)
//		{
//			float   x      = (int)(Math.random() * (Frame.getWidth()  / MainActivity.scale));
//			float   y      = (int)(Math.random() * (Frame.getHeight() / MainActivity.scale));
//			
...
//	{
//		dtime       += (((delta * 1f) / MainActivity.targetFps) * imageData.length) / ((hours * 60 * 60) + (minutes * 60) + (seconds));
//		
...
//			if (Frame.wasResized())
//			{
//				float resizeScale = ((float)Frame.getWidth() / MainActivity.oldWidth);
//				
...
//			}
//		
//			if ((Float)properties[0] > Frame.getWidth() / MainActivity.scale)
//			{
...
//				
//				float x = ((((dtime2 / (float)imageData.length) * Frame.getWidth() * 2) / MainActivity.scale)) - (index * (Frame.getWidth() / MainActivity.scale));
//				
//				if (index == 0)
//				{
//					if (x > Frame.getWidth() / MainActivity.scale)
//					{
//						x -= (Frame.getWidth() * 2) / MainActivity.scale;
//					}
//				}
//				
//				float y = (Frame.getHeight() / MainActivity.scale - MainActivity.textureSize * 2);
//				
//				float x2 = x - ((Frame.getWidth() / MainActivity.scale) / 2) + (MainActivity.textureSize);
//				
//				y -= .004f * (x2 * x2);
//				
//				if (index == 1)
...
//	{
//		GL.translatef(0, (Frame.getHeight() - 512f) / MainActivity.scale, 2f);
//		
//		int time2 = time;
//		
