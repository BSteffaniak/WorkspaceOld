...
//				colorBuffer.refreshData();
	...
	public boolean removeTile(int x, int y, int index)
	{
		...
		verticesBuffer[index].setData((x + y * WIDTH) * 4 * 2, GL.addRectVertexArrayf(0, 0, 0, 0, 0, null));
//		verticesBuffer.refreshData();
		
		texturesBuffer[index].setData((x + y * WIDTH) * 4 * 2, GL.addRectVertexArrayf(0, 0, 0, 0, 0, null));
//		texturesBuffer.refreshData();
