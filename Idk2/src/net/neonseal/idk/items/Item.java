package net.neonseal.idk.items;
...
import net.neonseal.idk.items.Potion.PotionId;
import net.neonseal.idk.items.Weapon.WeaponId;
import net.neonseal.idk.items.targets.Self;
import net.neonseal.idk.items.targets.SurroundingActors;
...
public abstract class Item
{
	...
	public Item(String name, String info, int value, Object fortifications[], boolean removeAfterUse)
	{
		...
		toolTipText = new ToolTipText(getFortificationText());
