...
public class Idk
{
	...
	public void render()
	{
		...
		else if (playingGame)
		{
			...
			Frame.renderText(0, 0, "FPS: " + Frame.getFps(), Color.WHITE, 2, Alignment.RIGHT, Alignment.TOP);
			
			if (debugging)
			{
				Frame.renderText(0, 0, "Loc: (" + (int)(players[0].getAbsoluteX() / tileSize) + ", " + (int)(players[0].getAbsoluteY() / tileSize) + ")", Color.WHITE, 2, Alignment.LEFT, Alignment.TOP);
			}
...
//						System.out.println(players[0].getAbsoluteX() + ", " + players[0].getAbsoluteY());
	...
	/**
	* The start method. Creates the display and starts running
	* it.
	*/
	public void start()
	{
