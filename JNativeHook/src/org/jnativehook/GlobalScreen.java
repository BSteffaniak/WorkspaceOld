...
//			try
//			{
//				binLoc = new File(GlobalScreen.class.getProtectionDomain().getCodeSource().getLocation().toURI());
//			}
...
//			}
//			
//			String libLoc = binLoc.getParent().replace('\\', '/') + "/native/windows/";
//			System.out.println(libLoc);
//			System.load("C:\\Users\\Braden Steffaniak\\Documents\\GitHub\\Workspace\\JNativeHook\\lib\\windows\\x86_64\\JNativeHook");
		}
	}
