...
include '../documents\github\workspace\arrowide\res\assembly\include\win64a.inc'
...
section '.text' code readable executable
	  ...
	  start:
		...
		invoke	CreateWindowEx,0,_class,_title,WS_VISIBLE+WS_OVERLAPPEDWINDOW+WS_CLIPCHILDREN+WS_CLIPSIBLINGS,550,200,800,600,NULL,NULL,[wc.hInstance],NULL
